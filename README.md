...
**Morse Decoder** is a project that involves reading in a Morse Code string and translating it to English using Ruby
...
- Function to input morse code messages and translate them to English
...
```sh
  cd my-folder
  git clone https://github.com/aamir-asaram/morse-decoder.git
```
